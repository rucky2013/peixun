...
<body>
	<div class="page-container">
		...
		<!-- END PAGE CONTENT -->
		<%@ include file="/WEB-INF/views/project/add.jsp"%>
	...
	<script	src="${ctx}/static/metronic/theme/assets/global/plugins/datatables/media/js/jquery.dataTables.min.js"></script>
	<script src="${ctx}/static/js/project/projectList.js"></script>
