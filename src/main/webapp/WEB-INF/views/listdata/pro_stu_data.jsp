...
<table
	...
	<thead>
			...
			<tr role="row" class="text-center">
				...
				<th class="sorting_disabled text-center" rowspan="1" colspan="1" style="width: 115px;">学时汇总</th>
			</tr>
			</thead>
...
<%-- 	<c:forEach items="${scores}" var="s">
		<tr role="row" class="text-center">
			...
			<td class="sorting_disabled" rowspan="1" colspan="1" style="width: 115px;"><a href="${ctx}/score/detail?userid=${s.userid}" target="_blank">${s.periodCount - s.periodCountDepartment}</a></td>
		</tr>
	</c:forEach>  --%>
	</tbody>
</table>
