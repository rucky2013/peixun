...
<table
	...
	<%-- 	<c:forEach items="${trains}" var="train">
		...
		<tr role="row">
			...
			<td class="sorting_disabled" rowspan="3" colspan="1">${score.periodCount - source.periodCountDepartment}</td>
		...
		<tr role="row">
			...
			<th class="sorting_disabled" rowspan="1" colspan="2" >部门级别学时汇总</th>			
		</tr>
