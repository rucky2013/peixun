...
<div class="modal fade" id="myapplyprojectid" tabindex="-1" role="basic"
	aria-hidden="true">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"
				  ...
				  <h4 class="modal-title">新增项目申请</h4>   
			</div>
			<div class="modal-body">
	            ...
	            <div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form  id="form_sample_2" class="form-horizontal" method="post" action="${ctx }/myapplyproject/save"  onsubmit="return validname();"> 
								...
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">项目名称 <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
							...
							<div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date form_datetime">
                                     <div class="input-icon right">
												<i class="fa"></i>
                                        <input type="text" size="16" readonly class="form-control" id="beginTime_id" name="beginTime">
												</div>
												<span class="input-group-btn">
                                    ...
                                    <div class="input-group date form_datetime">
                                     <div class="input-icon right">
										...
										* </span> 
													...
													<div class="col-md-4">
														<div class="input-group date form_datetime input-large"  data-date-format="yyyy-MM-dd HH:mm:ss" >
															 <div class="input-icon right">
															 <i class="fa"></i>
															<input type="text" size="16"  readonly name="beginTime"  class="form-control">
														 </div>
															<span class="input-group-btn">
